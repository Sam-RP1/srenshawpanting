...
const Contact = () => {
  return (
    ...
    <p data-aos="fade-up" data-aos-delay="100"><u><i>Important:</i></u> Please be sure to check you have entered all information correctly before submitting. Especially your email, otherwise I will not be able to contact you back.</p>
    <Form />
    </article>
    </section>
  );
