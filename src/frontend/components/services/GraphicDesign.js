...
const GraphicDesign = () => {
  return (
    ...
    <p style={{marginBottom: "10px"}}>Make your vision for professional graphics real.</p>
    ...
    <p>For all questions, queries or enquiries related to the graphic design service please use the <a href="/contact.html"><u><i>contact form</i></u></a> and select the "Logo Design" option from the "Select a Service" drop-down menu.</p>
    </article>
    </div>
    </section>
  );
